...
- For AWS-facing code, also consult the relevant [AWS service documentation](https://docs.aws.amazon.com/), the [AWS SDK for Go v2 documentation](https://docs.aws.amazon.com/sdk-for-go/v2/developer-guide/), and the official [aws-sdk-go-v2 repository](https://github.com/aws/aws-sdk-go-v2). Verify behavior against the service and SDK versions used by the changed module.
